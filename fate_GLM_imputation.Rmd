...
#### Create the interaction plots including imputed data 

```{r, warning=FALSE}
source("imp_interaction_plot.R")
```

#### Plots for the imputation data:
...
regtab <- function(impDat, aicTabImp, modList){
  # browser()
...
#### Predictive mean matching (pmm) [optional]
...
# cat("\n* and this method:", regMet, str_pad() )
cat("\n* * * * * * * * * * * * * * * * * * * * * * * * * * * *")
```
...
# impDat <- mice::cbind(impDat1, impDat2)
