...
source("fn_code/imp_sim_functions.R")
source("fn_code/missing_data.R")
source("fn_code/fit_models.R")
source("fn_code/visualize_data.R")
source("fn_code/edit_model_data.R")
# source("filter_dat.r")
...
### d. If needed, create the complete cases dataframe (not scaled/centered)
...
```{r create-impute, child="fate_GLM_imputation.Rmd"}
```
...
```{r q1-impute, child="fateGLM_imputation_analysis.Rmd"}
...
```{r q2-impute, child="fateGLM_imputation_analysis.Rmd"}
