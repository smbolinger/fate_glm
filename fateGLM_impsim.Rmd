...
var_list <-  c("nest_age", "cam_fateD", "cam_fateA", "cam_fateF", "cam_fateHu", "cam_fateS", "speciesLETE", "speciesLETE:nest_age", "obs_int", "fdate") # all vars
...
for(z in seq_along(mods4sim)){
  ...
  for(r in resp_list){
    ...
    biasfile1 <- paste0(params$home_dir, sprintf("out/bias_vals_%s_%s.csv", r, names(mods4sim)[z]))
