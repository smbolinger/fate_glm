...
# fname <- aicTab %>% save_tab(suffix=suffix, outdir = homeDir, rtf=TRUE) # pipes make deparse(substitute) not work
fname <- save_tab(aicTab, suffix=suffix, outdir = homeDir, rtf=TRUE)
