...
params:
  ...
  data_file: "cleaned_data/import_name.txt"
  missing_diag: TRUE
  separation: TRUE
  debug: TRUE
  plots1: TRUE
...
---
  ...
  data_file: '`r paste0(homeDir,read_file(paste0(homeDir,"cleaned_data/import_name.txt")))`'
...
```{r, include=FALSE}
source("functions/edit_model_data.R") # load functions
...
```{r load-data, echo=FALSE, message=FALSE}
  # filename <- paste0(homeDir,read_file(paste0(homeDir, "cleaned_data/import_name.txt")))
  # filename <- paste0(homeDir,read_file(paste0(homeDir, "cleaned_data/import_name.txt")))
# filename <- read_file(params$data_file)
filename <- "cleaned_data/grouped_0805_1225_ed2_20250906_1658.csv"
# filename <- "cleaned_data/grouped_0805_1225_ed2_20250905_1302.csv"
...
rm(nData)
print_pred(nd)
table(nd$field_fate, useNA="ifany")
```
